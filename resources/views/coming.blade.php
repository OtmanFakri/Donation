...
@section('content')
    <div class="h-screen">
        <main class="h-screen bg-cover bg-top sm:bg-top"
            ...
            <div class="mx-auto max-w-7xl px-4 py-16 text-center sm:px-6 sm:py-24 lg:px-8 lg:py-48">
                <p class="text-base font-semibold text-black text-opacity-50">Coming Soon</p>
                <h1 class="mt-2 text-4xl font-bold tracking-tight text-white sm:text-5xl">Uh oh! I think you’re
                    lost.</h1>
